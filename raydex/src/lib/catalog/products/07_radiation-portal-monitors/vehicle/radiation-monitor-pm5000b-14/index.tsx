...
export const radiationMonitorPm5000b14 = () => {
  ...
  const characteristics = {
    ...
    ['Минимальные обнаруживаемые количества радиоактивных материалов в зоне контроля 3 x 4.5 м']:
      (
        <div className={styles.table}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.value}>4500</div>
          </div>
        </div>
      ),
    ...
    ['Количество блоков детектирования']: <span>4 нейтронных</span>,
