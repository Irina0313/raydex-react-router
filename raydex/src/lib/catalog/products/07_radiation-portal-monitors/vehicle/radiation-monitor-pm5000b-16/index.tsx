...
export const radiationMonitorPm5000b16 = () => {
  ...
  const characteristics = {
      ...
      (
        <div className={styles.table}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.value}>1.15 (31)</div>
            <div className={styles.value}>1.8 (49)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
            ...
            <div className={styles.value}>0.185 (5)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
            ...
            <div className={styles.value}>0.115 (3.1)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
              <sup>57</sup>Co, МБк, (мкКи)
            </div>
            <div className={styles.value}>0.155 (4.2)</div>
            <div className={styles.value}>0.230 (6.2)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.value}>1.9</div>
            <div className={styles.value}>2.8</div>
          </div>
        </div>
      ),

    ['Количество блоков детектирования']: <span>8</span>,
    ...
    ['Масса']: <span>не более 1100 кг</span>,
