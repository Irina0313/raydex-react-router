...
export const radiationMonitorPm5000p02b = () => {
      ...
      (
        <div className={styles.table}>
          <div className={styles.row}>
            ...
            <div className={styles.value}>0.75 (20)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.value}>0.65 (1.8)</div>
          </div>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.value}>0.075 (2)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
              <sup>238</sup>U, г
            </div>
            <div className={styles.value}>870</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
              <sup>235</sup>U, г
      ...
      (
        <div className={styles.table}>
          <div className={styles.row}>
            ...
            <div className={styles.value}>1.29 (35)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
              <sup>137</sup>Cs, МБк, (мкКи)
            </div>
            <div className={styles.value}>0.21 (5.6)</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
              <sup>60</sup>Co, МБк, (мкКи)
            </div>
            <div className={styles.value}>0.11 (3)</div>
          </div>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.value}>190</div>
          </div>
          <div className={styles.row}>
            <div className={styles.name}>
              <sup>239</sup>Cf, нейтрон/c
            </div>
            <div className={styles.value}>11250</div>
          </div>
        </div>
      ),
