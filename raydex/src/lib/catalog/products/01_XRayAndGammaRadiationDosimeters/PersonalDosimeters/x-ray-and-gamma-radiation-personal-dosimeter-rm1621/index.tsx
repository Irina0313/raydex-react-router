...
export const xRayAndGammaRadiationPersonalDosimeterRm1621 = () => {
  const shortDescription = (
    <div className={styles.shortDescriptionContainer}>
      <p>
        Дозиметр предназначен для измерения индивидуального эквивалента дозы и
        мощности дозы гамма и рентгеновского излучений. Прибор выпускается в
  ...
  const fullDescription = (
    <div className={styles.fullDescription}>
      ...
      <p>
        ...
        <Link
          to="/catalog/x-ray-and-gamma-radiation-dosimeters/personal-dosimeters/x-ray-and-gamma-radiation-personal-dosimeter-rm1621a"
          style={{ color: '#2e69ad' }}
        >
          ДКГ-РМ1621A
        </Link>{' '}
      ...
      <p>
        В дополнение к функциям дозиметров ДКГ-РМ1621/
        <Link
          to="/catalog/x-ray-and-gamma-radiation-dosimeters/personal-dosimeters/x-ray-and-gamma-radiation-personal-dosimeter-rm1621a"
          style={{ color: '#2e69ad' }}
        >
  ...
  const characteristics = {
    ...
    ['Диапазон измерения МЭД']: <span>от 0,1 мкЗв/ч до 100 мЗв/ч</span>,
