...
export const xRayAndGammaRadiationPersonalDosimeterRm1621ma = () => {
  ...
  const fullDescription = (
    <div className={styles.fullDescription}>
      ...
      <p>
        ...
        <Link
          to={
            '/catalog/x-ray-and-gamma-radiation-dosimeters/personal-dosimeters/x-ray-and-gamma-radiation-personal-dosimeter-rm1621ma'
          }
        >
          ДКГ-PM1621МА
        </Link>
      ...
      <p>
        ...
        вибрационную и световую сигнализации для обнаружения и локализации
        радиоактивных материалов. Данные модификации сочетают в себе функции
        поисковых приборов и индивидуальных дозиметров на базе счетчиков
  ...
  const characteristics = {
    ...
    ['Наличие поискового режима']: <span>да</span>,
    ['Тип сигнализации']: <span>звуковая, вибрационная, световая</span>,
    ...
    ['Масса']: <span>(с элементом питания) не более 185 г</span>,
