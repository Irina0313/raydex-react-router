...
export const xRayAndGammaRadiationPersonalDosimeterRm1621a = () => {
  const shortDescription = (
    <div className={styles.shortDescriptionContainer}>
      <p>
        Дозиметр имеет расширенный диапазон измерения МЭД и предназначен для
        измерения индивидуального эквивалента дозы и мощности дозы гамма и
        рентгеновского излучений. Прибор выпускается в четырех модификациях.
      </p>
    </div>
  );
  ...
  const fullDescription = (
    <div className={styles.fullDescription}>
      ...
      <p>
        Дозиметры{' '}
        <Link
          to="/catalog/x-ray-and-gamma-radiation-dosimeters/personal-dosimeters/x-ray-and-gamma-radiation-personal-dosimeter-rm1621"
          style={{ color: '#2e69ad' }}
        >
          ДКГ-РМ1621
        </Link>{' '}
        и ДКГ-РМ1621А оснащены энергонезависимой памятью, в которой сохраняется
        до 1000 событий истории измерений мощности дозы, величины накопленной
        дозы, случаев и уровней превышения установленных порогов сигнализации.
      ...
      <h2>Модификации ДКГ-РМ1621М и ДКГ-РМ1621МА</h2>
      <p>
        ...
        /РМ1621A, модификации
        <Link
          to="/catalog/x-ray-and-gamma-radiation-dosimeters/personal-dosimeters/x-ray-and-gamma-radiation-personal-dosimeter-rm1621m"
          style={{ color: '#2e69ad' }}
        >
          ДКГ-РМ1621M
        </Link>{' '}
        и{' '}
        <Link
          to="/catalog/x-ray-and-gamma-radiation-dosimeters/personal-dosimeters/x-ray-and-gamma-radiation-personal-dosimeter-rm1621ma"
          style={{ color: '#2e69ad' }}
        >
          ДКГ-РМ1621МА
        </Link>{' '}
        имеют дополнительный поисковый режим и встроенную вибрационную и
        световую сигнализации для обнаружения и локализации радиоактивных
        материалов. Данные модификации сочетают в себе функции поисковых
        приборов и индивидуальных дозиметров на базе счетчиков Гейгера-Мюллера и
        являются малобюджетным решением для служб экстренного реагирования,
        таможенной службы и медицинских работников.
      </p>
  ...
  const characteristics = {
    ...
    ['Диапазон измерения МЭД']: (
      <span>от 0,1 мкЗв/ч до 1,00 Зв/ч или 1000мЗв/ч</span>
    ),
