...
export const radionuclideIdentificationDevices: ProductItemType[] = [
  {
    ...
    sliderDescription: (
      <span>
        ОДИН ИЗ САМЫХ МАЛОГАБАРИТНЫХ И ЛЕГКИХ РАДИОМЕТРОВ В МИРЕ. <br />
        Решает задачи от поиска и локализации источников ионизирующего излучения
        до измерения активности радионуклидов в обнаруженных источниках.
